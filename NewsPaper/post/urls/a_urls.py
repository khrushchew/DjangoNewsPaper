...
urlpatterns = [
    path('', ListPostView.as_view(type_of_post='A')),
    path('<int:pk>/', RetrievePostView.as_view()),
    path('create/', CreatePostView.as_view(type_of_post='A')),
    path('<int:pk>/update/', UpdatePostView.as_view(type_of_post='A')),
    path('<int:pk>/delete/', DeletePostView.as_view(type_of_post='A'))
]
